...
1. **Load Notes:** - For the week of 6th April to 10th April
   - *Step 1:* Load Notes using a simple WITH OPEN, Read from Notes.MD.
   - *Step 2:* Chunk it
   - *Step 3:* Print the chunks
2. **Build a Simple RAG Chatbot:**  
...
4. **Create an AI Workflow (Agent Prototype):**  
