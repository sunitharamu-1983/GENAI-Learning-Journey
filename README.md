...
My journey from beginner to building RAG-based AI systems and agents

# 🚀 GenAI Learning Journey

This repository documents my journey of learning and building Generative AI systems.

## 🎯 Goal
To evolve from understanding fundamentals to building:
- RAG-based applications
- AI agents
- Real-world GenAI systems

## 📚 Structure
- Foundations (Python, vectors, basics)
...
## 🛠️ Projects
### AI Learning Companion (in progress)
An AI system that:
- Understands my course notes
- Answers questions
- Helps with revision
- Evolves as I learn
